...
public class ControlPanel extends JPanel {
	...
	public ControlPanel() {
		...
		// Panel to display the buttons to find duplicated files and folders
		JPanel duplicatedPanel = new JPanel();
		dupFiles = new JButton("Find Duplicated Files");
		dupFolders = new JButton("Find Duplicated Folders");
		dupFiles.addActionListener(listener);
		dupFolders.addActionListener(listener);
		duplicatedPanel.add(dupFiles);
		duplicatedPanel.add(dupFolders);
	...
	private class ButtonListener implements ActionListener {
		// Invokes the methods to print the File Tree
			...
			try {
				...
				if (fileObject != null)
					if (tree == null || !tree.getRoot().getData().getLongName().equals(fileObject.getCanonicalPath())) {
						...
						tree = new FileTree(fileObject.getCanonicalPath());
					}
				if (tree == null) {
